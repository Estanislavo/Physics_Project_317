...
STRINGS = {
    "ru": {
        ...
        "menu.start": "Начать моделирование",
        ...
        "sim.settings": "Настройки моделирования",
        "sim.N": "N",
        "sim.N.unit": "1-100",
        ...
        "sim.sigma": "σ",
        "sim.sigma.unit": "1-30",
        "sim.sigma.help": "Характерное расстояние Леннарда-Джонса",
        "sim.De": "De",
        "sim.De.unit": "0-100",
        ...
        "sim.r0": "r₀",
        "sim.r0.unit": "1-20",
        "sim.r0.help": "Равновесное расстояние (Морзе)",
        "sim.vessel": "Сосуд",
